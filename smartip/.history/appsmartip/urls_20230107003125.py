...
urlpatterns = [
     ...
     path('admin_db/pendings/status/', admin_db_dev_status, name='PendingStatus'),
     path('admin_db/pendings/status/add', add_dev_status, name='PendingStatusAdd'),
     path('admin_db/pendings/status/edit/<id>/', edit_dev_status, name='PendingStatusEdit'),
     path('pending_status_delete/<id>/', delete_dev_status, name='PendingStatusDelete'),
