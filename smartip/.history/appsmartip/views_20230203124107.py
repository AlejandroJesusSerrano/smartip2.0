...
def dev_user_details(request, id):
     ...
     return render(request, 'appsmartip/admin_db/device_users/dev_users_details.html', data)
...
def edit_dev_user(request):
     ...
     if request.method == 'POST':
          dev_user_edit = DevUsersFormAdd(data=request.POST, instance=dev_user)
