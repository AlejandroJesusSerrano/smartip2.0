...
def edit_dev_type(request, id):
     ...
     edit_dev_type_form = get_object_or_404(DevType, id=id)
     
     data = {
          'edit_dev_type_form': DevTypeFormAdd(instance=edit_dev_type_form),
     }

     if request.method == 'POST':
          edit_type_form = DevTypeFormAdd(data=request.POST, instance=edit_dev_type_form)
