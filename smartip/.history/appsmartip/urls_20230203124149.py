...
urlpatterns = [
     ...
     path('admin_db/devuser/', admin_db_dev_users, name='DevUsers'),
     path('admin_db/devuser/add', add_dev_user, name='DevUserAdd'),
     path('admin_db/devuser/details/<id>/', dev_user_details, name='DevUserDetails'),
     path('admin_db/devuser/edit/<id>', edit_dev_user, name='DevUserEdit'),
