...
#* Device Form Add
class DevStatusFormAdd(forms.ModelForm):
     ...
     class Meta:
          ...
          help_texts = {
               'status': ('Ingrese el nuevo estado (Máximo 15 caracteres) ')
          }
...
#* Pending Form Add
class PendingStatusFormAdd(forms.ModelForm):
     ...
     class Meta:
          ...
          labels = {
               'status': ('Estado de Tarea Pendiente: '),

          }

          help_texts = {
               'status': ('Ingrese el nuevo estado (Máximo 19 caracteres) ')
          }
...
#* Technical Form Add
class TechFormAdd(forms.ModelForm):
     ...
     class Meta:
          ...
          help_texts = {
               'name': ('Ingrese el nombre (Máximo 30 caracteres) '),
               'last_name': ('Ingrese el apellido (Máximo 30 caracteres) ')
          }
...
#* Device User Form Add
class DevUsersFormAdd(forms.ModelForm):
     class Meta:
          ...
          labels = {
               ...
               'last_name': ('Apellido'),
               'email': ('E-m@il'),
               'message_account': ('Usuario Mensajería'),
               'message_pass': ('Contraseña Mensajería'),
               'username': ('Nombre de Usuario'),
               'standard_password': ('¿Contraseña de serie?'),
               'cuil': ('CUIL'),
               'observaations': ('Observaciones')
          }

          help_texts = {
               'name': ('Máximo 30 caracteres'), 
               'last_name': ('Máximo 30 caracteres'),
               'message_account': ('Maximo 15 caracteres'),
               'username': ('Maximo 6 caracteres'),
               'cuil': ('Ingrese los 11 numeros sin guiones')
          }
          ...
          widgets = {
               ...
               'message_account': forms.TextInput(attrs={
                    'class': 'form-control',
                    'id': 'messageAccount',
               }),
               
               'message_pass': forms.TextInput(attrs={
                    'class': 'form-control',
                    'id': 'messagePass',
               }),
               ...
               'standard_password': forms.CheckboxInput(attrs={
                    'class': 'form-control',
                    'id': 'standardPassword',
               }),
               
               'cuil': forms.NumberInput(attrs={
                    'class': 'form-control',
                    'id': 'cuilNumber',
               }),
