...
class Model(models.Model):
     dev_type = models.ForeignKey(DevType, on_delete=models.CASCADE, unique=True)
...
class Device(models.Model):
     ...
     dev_type = models.ForeignKey(Model, related_name='device_type', to_field='dev_type', on_delete=models.CASCADE)
     model = models.ForeignKey(Model, related_name='dev_model', to_field='model', on_delete=models.CASCADE)
...
class Pendings(models.Model):
     ...
     state = models.ForeignKey(State, default='Pendiente', on_delete=models.CASCADE)
