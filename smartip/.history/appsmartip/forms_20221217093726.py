...
class DevTypeFormAdd(forms.ModelForm):
     ...
     def clean_model(self):
          model = self.cleaned_data['dev_type']
          is_in = DevType.objects.filter(dev_type__iexact=model).exists()
...
class InternetAccessAddForm(forms.ModelForm):
     ...
     def clean_model(self):
          model = self.cleaned_data['access_type_form']
          is_in = Internet.objects.filter(access_type_form__iexact=model).exists()
