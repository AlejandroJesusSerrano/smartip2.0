...
class ServiceRequest(models.Model):
     ...
     name_to_request = models.CharField(max_length=30)
     last_name_to_request = models.CharField(max_length=30)
     office = models.ForeignKey(Office, on_delete=models.CASCADE)
...
class Pendings(models.Model):
     date = models.DateField(auto_created=Now, nullable=True)
     required_by = models.CharField(max_length=6)
     personal = models.BooleanField()
     name_to_request = models.CharField(max_length=30)
     last_name_to_request = models.CharField(max_length=30)
     device = models.ForeignKey(Device, on_delete=models.CASCADE)
     ...
     updated = models.DateField(auto_now=Now)
