...
urlpatterns = [
     ...
     path('add_dev_type/', add_dev_type, name='AddType'),
     path('update_dev_type/<int:id>',update_dev_type, name ='UpdateType')
     path('delete_dev_type/<int:id>/', delete_dev_type, name='DeleteType'),
