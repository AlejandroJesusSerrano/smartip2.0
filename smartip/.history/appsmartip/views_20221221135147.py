...
#* Ediffices Views
#* Ediffices List
@permission_required('appsmartip.view_ediffice')
...
#* Ediffices Add
@permission_required('appsmartip.add_ediffice')
...
#? Edit Location
@permission_required('appsmartip.modify_ediffice')
def ediffice_edit(request, id):
     ediffice = get_object_or_404(id=id)
     data={
          'ediffice_edit_form': EdifficeAddForm(instance=ediffice)
     }
     
     if request.method == 'POST':
          ediffice_edit = EdifficeAddForm(instance=ediffice)
          ediffice_edit.save()
