...
def home(request): 
     ...
     if searchP:
          pendings = Pendings.objects.filter(
               ...
               Q(required_by__username__icontains = searchP) |
               Q(service_for__name__icontains = searchP) |
               Q(device__model__icontains = searchP) |
               Q(last_revision__icontains = searchP) |
               Q(reason__icontains = searchP) |
               Q(tech_revision__name__icontains = searchP) |
