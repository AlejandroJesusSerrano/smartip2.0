...
class HomeForm(forms.ModelForm):
     class Meta:
          ...
          help_texts = {
               ...
               'service_for': ('Seleccione el usuario para el que es el Servicio'),
               'device': ('Seleccione el dispositivo que presenta los inconvenientes')
          }
          widgets = {
               'required_by': forms.SelectMultiple(attrs={
                    'class': 'form-control', 
                    'id':'required_by',
